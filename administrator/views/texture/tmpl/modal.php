...
<script type="text/javascript">
	Joomla.submitbutton = function(task)
	{
		if (task == 'texture.cancel' || document.formvalidator.isValid(document.id('item-form')))
		{
			...
			if (window.opener && (task == 'texture.save' || task == 'texture.cancel'))
			{
...
<div class="pull-right">
	<button class="btn btn-primary" type="button" onclick="Joomla.submitbutton('texture.apply');"><?php echo JText::_('COM_EVOLUTIONARY_TOOLBAR_APPLY') ?></button>
	<button class="btn btn-primary" type="button" onclick="Joomla.submitbutton('texture.save');"><?php echo JText::_('COM_EVOLUTIONARY_TOOLBAR_SAVE') ?></button>
	<button class="btn" type="button" onclick="Joomla.submitbutton('texture.cancel');"><?php echo JText::_('JCANCEL') ?></button>
</div>
