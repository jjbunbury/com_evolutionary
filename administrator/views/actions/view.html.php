...
class EvolutionaryViewActions extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_EVOLUTIONARY_ACTIONS_TITLE'), 'stack action');
		...
		{
			JToolbarHelper::publish('actions.publish', 'COM_EVOLUTIONARY_TOOLBAR_PUBLISH', true);
			JToolbarHelper::unpublish('actions.unpublish', 'COM_EVOLUTIONARY_TOOLBAR_UNPUBLISH', true);
		...
		{
			JToolbarHelper::deleteList('', 'actions.delete', 'COM_EVOLUTIONARY_TOOLBAR_EMPTY_TRASH');
		}
