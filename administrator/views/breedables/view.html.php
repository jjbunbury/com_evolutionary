...
/**
 * View class for a list of breedables.
 *
 * @package     Joomla.Administrator
 * @subpackage  com_evolutionary
 * @since       1.6
...
class EvolutionaryViewBreedables extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_EVOLUTIONARY_BREEDABLES_TITLE'), 'stack breedable');

		if ($this->canDo->get('core.create') || (count($user->getAuthorisedCategories('com_evolutionary', 'core.create'))) > 0 )
		{
			JToolbarHelper::addNew('breedable.add');
		}

		if (($this->canDo->get('core.edit')) || ($this->canDo->get('core.edit.own')))
		{
			JToolbarHelper::editList('breedable.edit');
		}

		if ($this->canDo->get('core.edit.state'))
		{
			JToolbarHelper::publish('breedables.publish', 'COM_EVOLUTIONARY_TOOLBAR_PUBLISH', true);
			JToolbarHelper::unpublish('breedables.unpublish', 'COM_EVOLUTIONARY_TOOLBAR_UNPUBLISH', true);
			JToolbarHelper::archiveList('breedables.archive');
			JToolbarHelper::checkin('breedables.checkin');
		}

		if ($this->state->get('filter.published') == -2 && $this->canDo->get('core.delete'))
		{
			JToolbarHelper::deleteList('', 'breedables.delete', 'COM_EVOLUTIONARY_TOOLBAR_EMPTY_TRASH');
		}
		elseif ($this->canDo->get('core.edit.state'))
		{
			JToolbarHelper::trash('breedables.trash');
		}
