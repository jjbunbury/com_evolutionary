...
<script type="text/javascript">
	Joomla.submitbutton = function(task)
	{
		if (task == 'configuration.cancel' || document.formvalidator.isValid(document.id('item-form')))
		{
			...
			if (window.opener && (task == 'configuration.save' || task == 'configuration.cancel'))
			{
...
<div class="pull-right">
	<button class="btn btn-primary" type="button" onclick="Joomla.submitbutton('configuration.apply');"><?php echo JText::_('COM_EVOLUTIONARY_TOOLBAR_APPLY') ?></button>
	<button class="btn btn-primary" type="button" onclick="Joomla.submitbutton('configuration.save');"><?php echo JText::_('COM_EVOLUTIONARY_TOOLBAR_SAVE') ?></button>
	<button class="btn" type="button" onclick="Joomla.submitbutton('configuration.cancel');"><?php echo JText::_('JCANCEL') ?></button>
</div>
