...
class EvolutionaryViewConfigurations extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_EVOLUTIONARY_TITLE_CONFIGURATIONS'), 'configurations.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_evolutionary&view=configurations');
	...
	protected function getSortFields()
	{
		...
		'a.title' => JText::_('COM_EVOLUTIONARY_CONFIGURATIONS_TITLE'),
